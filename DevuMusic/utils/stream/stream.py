...
import config
from DevuMusic import Carbon, YouTube, app
from DevuMusic.core.call import Devu
from DevuMusic.misc import db
from DevuMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from DevuMusic.utils.exceptions import AssistantErr
from DevuMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from DevuMusic.utils.inline.playlist import close_markup
from DevuMusic.utils.pastebin import Devubin
from DevuMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Devu.force_stop_stream(chat_id)
