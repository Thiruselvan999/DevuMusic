...
from DevuMusic.utils.database import get_authuser_names, get_cmode
from DevuMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from DevuMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Devu.stop_stream(message.chat.id)
    except:
        pass
