...
from DevuMusic.misc import SUDOERS, db
from DevuMusic.utils.database import (is_active_chat,
...
from DevuMusic.utils.formatters import seconds_to_min
from DevuMusic.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Devu.pause_stream(chat_id)
        ...
        await Devu.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Devu.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
