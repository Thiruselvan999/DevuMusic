...
- These are the minimum required vars need to setup to make Devu Music Bot functional.

1. `API_ID` : Get it from my.telegram.org 
2. `API_HASH`  : Get it from my.telegram.org 
3. `BOT_TOKEN` : Get it from [@Botfather](http://t.me/BotFather) in Telegram
4. `MONGO_DB_URI` : Get mongo db [from here.](https://notreallyshikhar.gitbook.io/Devumusicbot/deployment/mongodb)
...
- You can play tracks or playlists from spotify from Devu Music bot
- You'll need these two vars to make spotify play working. This is not essential , you can leave them blank if you want.

### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/Devumusicbot/deployment/spotify)
...
- If you plan to use Devu Music Bot with your own customized or modified code.
...
- You can change images which are used in Devu Music Bot.
- You can generate telegaph links from [@Devu_Robot](http://t.me/Devu_Robot) and use it here.
